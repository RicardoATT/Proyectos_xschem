...
only_toplevel=true
value="
*PULSE(0 1.8 15.001u 1n 1n 100n 200n 300)
.control
  save all
  tran 10n 100u
  write 7T1R_tb.raw
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/7T1R_tb.raw tran"
}
C {devices/vsource.sym} -80 -210 0 0 {name=V3 value="PWL(0 0 19.999u 0 20u 1.8)"}
...
C {/home/ricardo/RATT_repos/Proyectos_xschem/synapse/7T1R.sym} -180 -110 0 0 {name=x1}
C {devices/vsource.sym} -340 -170 0 0 {name=V2 value=1.8}
