...
.control
  save all
  tran 1n 50u
  write memristance.raw
  wrdata memristance.ssv i(Vread)
.endc
" }
C {sky130_fd_pr/corner.sym} 880 -270 0 0 {name=CORNER only_toplevel=true corner=tt}
C {devices/vsource.sym} 370 -430 0 0 {name=Vwl value=1.8

}
C {devices/vsource.sym} 250 -730 0 0 {name=Vbl value="PULSE(1.8 -1.8 1n 1n 1n 25u 50u 1)"}
C {devices/gnd.sym} 560 -360 0 0 {name=l1 lab=GND}
C {devices/launcher.sym} 860 -380 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/memristance.raw tran"
}
...
C {/home/ricardo/RATT_repos/Proyectos_xschem/synapse/1T1R.sym} 870 -470 0 0 {name=x1}
