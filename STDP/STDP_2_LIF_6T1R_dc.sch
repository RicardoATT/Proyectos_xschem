...
C {devices/vsource.sym} 910 -170 0 0 {name=V2 value=0.6}
...
C {devices/isource.sym} -360 -120 0 1 {name=I0 value=3u}
C {devices/gnd.sym} -360 -70 0 0 {name=l20 lab=GND}
...
C {devices/vsource.sym} 970 -170 0 0 {name=V3 value=0.6}
...
C {devices/ammeter.sym} -360 -190 0 0 {name=Vmeas savecurrent=true}
C {devices/ammeter.sym} -210 -240 3 0 {name=Vmeas3 savecurrent=true}
