...
S {}
E {}
B 2 -1380 -1200 -580 -800 {flags=graph
y1=-0.12
y2=1.9
ypos1=0
ypos2=2
...
B 2 -2180 -1200 -1380 -800 {flags=graph
y1=-2.4e-06
y2=0.00042
ypos1=0
ypos2=2
...
\\"Isyn21 (A);i(vmeas21)\\"
\\"Isyn22 (A);i(vmeas22)\\""}
B 2 -2180 -800 -1380 -400 {flags=graph
y1=-0.29
y2=2
ypos1=0
ypos2=2
...
node="\\"Vpos1 [V];vpos1\\"
\\"Vpos2 [V];vpos2\\""}
B 2 -1380 -800 -580 -400 {flags=graph
y1=2.64298
y2=5.16612
ypos1=0
ypos2=2
...
B 2 -1380 -400 -580 0 {flags=graph
y1=0
y2=1.8
ypos1=0
ypos2=2
...
\\"Training;training\\"
\\"Inference;inference\\""}
B 2 -2180 -400 -1380 0 {flags=graph
y1=0
y2=1.8
ypos1=0
ypos2=2
...
\\"Control 2;ctrl2\\""}
B 2 -2180 -1600 -1380 -1200 {flags=graph
y1=-3.1e-11
y2=5.8e-08
ypos1=0
ypos2=2
...
node="\\"Ip1 (A);i(vmeas3)\\"
\\"Ip2 (A);i(vmeas4)\\""}
B 2 -1380 -1600 -580 -1200 {flags=graph
y1=-0.028
y2=2
ypos1=0
ypos2=2
...
node="\\"Vp1 [V];vp1\\"
\\"Vp2 [V];vp2\\""}
B 2 -2180 -2000 -1380 -1600 {flags=graph
y1=-1.15845e-07
y2=1.4252e-06
ypos1=0
ypos2=2
...
\\"Im21 (A);i(vmeas21)\\"
\\"Im22 (A);i(vmeas22)\\""}
B 2 -1380 -2000 -580 -1600 {flags=graph
y1=-8.9e-05
y2=0.073
ypos1=0
ypos2=2
...
N -2790 -860 -2780 -860 {
lab=vbias}
N -3970 -1120 -3970 -1100 {
lab=GND}
N -3970 -1200 -3970 -1180 {
lab=vdd_syn1}
...
"
spice_ignore=false}
C {devices/code_shown.sym} -3770 -150 0 0 {name=NGSPICE1
only_toplevel=true
value="
.param Lp_delay=7
.param Wp_delay=0.45
...
.endc
" }
C {devices/launcher.sym} -2370 -1320 0 0 {name=h1
descr="load waves" 
...
C {devices/gnd.sym} -3710 -960 0 0 {name=l29 lab=GND}
C {devices/lab_pin.sym} -3710 -1060 2 0 {name=p16 sig_type=std_logic lab=vdd_delay}
...
C {devices/vsource.sym} -3970 -450 0 0 {name=V14 value="PWL(0 0 14.9u 0 15u 1.8 199.9u 1.8 200u 0)"}
...
C {devices/vsource.sym} -3970 -310 0 0 {name=V15 value="PWL(0 0 204.9u 0 205u 1.8)"}
...
C {devices/vsource.sym} -3790 -730 0 0 {name=V12 value="PWL(0 0 204.9u 0 205u 1.8)"}
...
C {devices/vsource.sym} -3810 -870 0 0 {name=V9 value=0.5}
C {devices/gnd.sym} -3810 -820 0 0 {name=l75 lab=GND}
C {devices/lab_pin.sym} -3810 -920 2 0 {name=p82 sig_type=std_logic lab=vbias}
C {devices/vsource.sym} -3800 -1010 0 0 {name=V3 value="PWL(0 0 204.9u 0 205u 1.8)"}
C {devices/gnd.sym} -3800 -960 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} -3800 -1060 2 0 {name=p6 sig_type=std_logic lab=vdd_pos}
C {devices/vsource.sym} -3600 -1010 0 0 {name=V5 value=1.8}
C {devices/gnd.sym} -3600 -960 0 0 {name=l1 lab=GND}
C {devices/lab_pin.sym} -3600 -1060 2 0 {name=p1 sig_type=std_logic lab=vdd_sw}
C {devices/vsource.sym} -3520 -1010 0 0 {name=V6 value=1.8}
C {devices/gnd.sym} -3520 -960 0 0 {name=l2 lab=GND}
C {devices/lab_pin.sym} -3520 -1060 2 0 {name=p3 sig_type=std_logic lab=vdd_tg}
C {devices/vsource.sym} -3970 -870 0 0 {name=V7 value=0.5}
C {devices/gnd.sym} -3970 -820 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} -3970 -920 2 0 {name=p8 sig_type=std_logic lab=vb_pre}
C {devices/vsource.sym} -3890 -870 0 0 {name=V8 value=0.5}
...
C {/home/ricardo/RATT_repos/Proyectos_xschem/switch/sw.sym} -2730 -370 0 0 {name=x256}
...
C {devices/ammeter.sym} -3310 -1060 1 0 {name=Vmeas2 savecurrent=true}
...
C {devices/vsource.sym} -3970 -1150 0 0 {name=V10 value="PWL(0 1.8 99.9u 1.8 100u 0 204.9u 0 205u 1.8)"}
C {devices/gnd.sym} -3970 -1100 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} -3970 -1200 2 0 {name=p51 sig_type=std_logic lab=vdd_syn1}
C {devices/vsource.sym} -3870 -1150 0 0 {name=V20 value="PWL(0 1.8 9.9u 1.8 10u 0 104.9u 0 105u 1.8)"}
C {devices/gnd.sym} -3870 -1100 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} -3870 -1200 2 0 {name=p7 sig_type=std_logic lab=vdd_syn2}
...
C {devices/lab_pin.sym} -2210 -140 3 0 {name=p62 sig_type=std_logic lab=vdd_pos}
...
C {devices/vsource.sym} -3600 -730 0 0 {name=V16 value="PWL(0 0 204.9u 0 205u 1.4)"}
C {devices/gnd.sym} -3600 -680 0 0 {name=l25 lab=GND}
C {devices/lab_pin.sym} -3600 -780 2 0 {name=p71 sig_type=std_logic lab=ctrl_pos}
C {devices/vsource.sym} -3440 -1010 0 0 {name=V17 value=1.8}
C {devices/gnd.sym} -3440 -960 0 0 {name=l26 lab=GND}
C {devices/lab_pin.sym} -3440 -1060 2 0 {name=p80 sig_type=std_logic lab=vdd_inh}
...
C {devices/lab_pin.sym} -3300 -170 0 0 {name=p83 sig_type=std_logic lab=vp1}
C {devices/lab_pin.sym} -3300 -130 0 0 {name=p84 sig_type=std_logic lab=vp2}
C {devices/lab_pin.sym} -2440 -260 0 0 {name=p86 sig_type=std_logic lab=inh1}
C {devices/lab_pin.sym} -2220 -260 0 0 {name=p87 sig_type=std_logic lab=inh2}
C {devices/vsource.sym} -3420 -730 0 0 {name=V18 value=1.8}
C {devices/gnd.sym} -3420 -680 0 0 {name=l28 lab=GND}
C {devices/lab_pin.sym} -3420 -780 2 0 {name=p88 sig_type=std_logic lab=vinh}
C {/home/ricardo/RATT_repos/Proyectos_xschem/delay/delay.sym} -2900 -30 0 0 {name=x13}
C {devices/gnd.sym} -3080 -100 0 0 {name=l30 lab=GND}
C {devices/lab_pin.sym} -3080 -200 0 0 {name=p92 sig_type=std_logic lab=vdd_delay}
C {devices/lab_pin.sym} -3010 -150 2 0 {name=p91 sig_type=std_logic lab=inh_d}
