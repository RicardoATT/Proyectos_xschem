...
.control
	...
	wrdata PFET_vgs_sqrtid2.ssv sqrt(i(Vmeas1)) sqrt(i(Vmeas2)) sqrt(i(Vmeas3)) sqrt(i(Vmeas4)) sqrt(i(Vmeas5))
.endc
"}
...
C {devices/vsource.sym} -280 -50 0 0 {name=V4 value=0.35 savecurrent=false}
...
C {devices/vsource.sym} -20 -50 0 0 {name=V5 value=0.25 savecurrent=false}
...
C {devices/vsource.sym} -430 210 0 0 {name=V6 value=0.15 savecurrent=false}
...
C {devices/vsource.sym} -170 210 0 0 {name=V7 value=0.05 savecurrent=false}
...
C {sky130_fd_pr/pfet_01v8.sym} -670 -80 0 0 {name=M1
L=0.45
W=1.35
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -410 -80 0 0 {name=M2
L=0.45
W=1.35
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -150 -80 0 0 {name=M3
L=0.45
W=1.35
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -560 180 0 0 {name=M4
L=0.45
W=1.35
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} -300 180 0 0 {name=M5
L=0.45
W=1.35
nf=1
mult=1
