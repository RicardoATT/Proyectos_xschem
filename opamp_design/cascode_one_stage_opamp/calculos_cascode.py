...
print("W_{10} = \\frac{W_{10}}{L_{10}} \\times L_{min} = ",round(W10_L10, 6),"\\times",L0," \\\\")
...
print("R_{OUT} \\approx (r_{ds2}\\times g_{m4}\\times r_{ds4})||(r_{ds6}\\times g_{m6}\\times r_{ds8}) \\\\")
print("R_{OUT} \\approx (",round(rds2, 3),"\\times",round(gm4, 3),"\\times",round(rds2, 3),")||(",round(rds6, 3),"\\times",round(gm6, 3),"\\times",round(rds6, 3),") \\\\")
...
print("W_{1} = W_{2} = W_{3} = W_{4} = ",round(W1*1e6, 3),' \\mu m \\\\')
print("W_{5} = W_{6} = W_{7} = W_{8} = ",round(W5*1e6, 3),' \\mu m \\\\')
print("W_{9} = ",round(W9*1e6, 3),' \\mu m \\\\')
print("W_{10} = ",round(W10*1e6, 3),' \\mu m \\\\')
print("W_{11} = ",round(W11*1e6, 3),' \\mu m \\\\')
