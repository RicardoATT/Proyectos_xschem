...
print("I_{1} = \\frac{I_{3}}{2} = \\frac{",round(I3, 6),"}{2} \\\\")
...
print("W_{7} = W_{6} = W_{5} = W_{4}= ",round(W4*1e6, 6)," \\mu m \\\\")
...
print("\\\\")
print("\\textbf{Paso 7} \\\\")
print("V_{DS3}(sat) = \\sqrt{\\frac{I_{3}}{K'_{N} \\times \\frac{W_1}{L_1}}} - V_{TN} = \\sqrt{\\frac{",round(I3,6),"}{",round(Kn,6)," \\times ",round(W1_L1, 6),"}} - ",Vthn," \\\\")
...
print("g_{m1} = \\sqrt{2 \\times I_{1} \\times K'_{N} \\times \\frac{W_1}{L_1}} = \\sqrt{2 \\times ",round(I1,6)," \\times ",round(Kn, 6)," \\times ",round(W1_L1, 6),"} \\\\")
print("g_{m1} = ",round(gm1*1e6, 6)," \\mu S \\\\")
print("g_{m4} = \\sqrt{2 \\times I_{4} \\times K'_{P} \\times \\frac{W_4}{L_4}} = \\sqrt{2 \\times ",round(I4,6)," \\times ",round(Kp, 6)," \\times ",round(W4_L4, 6),"} \\\\")
...
print("R_{OUT} = \\left( ",round(gm8, 3)," \\times ",round(rds8, 3),"^{2} \\right) || \\left[ ",round(gm6, 3)," \\times ",round(rds6, 3)," \\times \\left( ",round(rds1, 3)," || ",round(rds4, 3)," \\right) \\right] \\\\")
...
print("W_{1} = W_{2} = ",round(W1*1e6, 3),' \\mu m \\\\')
print("W_{3} = ",round(W3*1e6, 3),' \\mu m \\\\')
print("W_{4} = W_{5} = W_{6} = W_{7} = ",round(W4*1e6, 3),' \\mu m \\\\')
print("W_{8} = W_{9} = W_{10} = W_{11} = ",round(W8*1e6, 3),' \\mu m \\\\')
print("L_{1} - L_{11} = ",round(L0*1e6, 3),' \\mu m \\\\')
