...
.control
	...
	wrdata PFET_vgs_id.ssv i(Vmeas1) i(Vmeas2) i(Vmeas3) i(Vmeas4) i(Vmeas5) i(Vmeas6)
	wrdata PFET_vgs_sqrtid.ssv sqrt(i(Vmeas1)) sqrt(i(Vmeas2)) sqrt(i(Vmeas3)) sqrt(i(Vmeas4)) sqrt(i(Vmeas5)) sqrt(i(Vmeas6))
.endc
"}
