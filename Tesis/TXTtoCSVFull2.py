...
def txt_to_csv(input_txt, output_csv):
    ...
    with open(output_csv, 'w', newline='') as csv_file:
        ...
        for line in lines:
            ...
            if len(columns) >= 3:  # Asegurarse de que haya al menos 300 columnas
...
# Llamar a la función para convertir .txt a .csv
    #archivotxt = f"Input_LIF_Frq{i}.txt"
    #archivocsv = f"Input_LIF_Frq{i}.csv"
    #txt_to_csv(archivotxt, archivocsv)

txt_to_csv("Input_LIF_VbvsVout.txt", "Input_LIF_VbvsVout.csv")
