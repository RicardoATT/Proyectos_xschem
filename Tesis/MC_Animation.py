...
file_names = [f'Input_LIF_MC{i}.txt' for i in range(1,101)]  # Ajusta los nombres de los archivos según corresponda
...
# Crear la animación
ani = animation.FuncAnimation(fig, update, frames=len(file_names), interval=100, repeat=True)
